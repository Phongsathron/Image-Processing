...
D0 = 0.1*PQ(2); % 0.2 : Radian of a filter
F = fft2(f, PQ(1), PQ(2)); % Converting f to frequency domain with zero padding
%H = exp(-(U.^2 + V.^2)/(2*(D0^2))); % A filter on frequency domain
